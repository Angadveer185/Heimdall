...
// Google OAuth Routes
authRouter.get("/google", (req, res, next) => controller.initiateGoogle(req, res, next));
authRouter.get("/google/callback", (req, res, next) => controller.googleCallback(req, res, next));
